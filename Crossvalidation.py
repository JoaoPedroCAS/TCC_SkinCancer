...
if __name__ == "__main__":
   ...
   ##main(" cancer/libsvm/data_VGG.txt") ##Se usando as features do VGG
   ##main(" cancer/libsvm/data_Xception.txt") ##Se usando as features do Xception
    main("cancer/libsvm/data_Inception.txt") ##Se usando as features do Inception
